...
public class RouteFinderWebServicerTest {

    private static final Logger LOG = LoggerFactory.getLogger(RouteFinderWebServicerTest.class);

    @Inject
    private RouteFinderWebService routeFinderWebService;

    @Before
    public void setUp() throws Exception {
        LOG.trace("setUp");

        assertNotNull(routeFinderWebService);
    }
    ...
    public void testFindShortestRoute() throws Exception {
        ...
        Route result = routeFinderWebService.findRoute(root.getPosition().getLatitude(), root.getPosition().getLongitude(), target.getPosition().getLatitude(), target.getPosition().getLongitude());
