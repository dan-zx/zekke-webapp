...
/**
 * ServiceException class is subclass of ZekkeException. It is used for service
 * exceptions.
 *
 * @author Daniel Pedraza
 * @since version 1.0
 */
public class ServiceException extends ZekkeException {
     ...
     * message.
     */
    public ServiceException(String key, Object[] formatArgs) {
     ...
     * message.
     */
    public ServiceException(String key, Throwable cause, Object[] formatArgs) {
     ...
     * type.
     */
    public static class Builder extends ZekkeExceptionBuilder<ServiceException> {
    }
}