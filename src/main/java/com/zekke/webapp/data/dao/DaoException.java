...
/**
 * DaoException class is subclass of ZekkeException. It is used for DAO
 * exceptions.
 *
 * @author Daniel Pedraza
 * @since version 1.0
 */
public class DaoException extends ZekkeException {

    private static final long serialVersionUID = -907679389743109385L;
     ...
     * message.
     */
    public DaoException(String key, Object[] formatArgs) {
     ...
     * message.
     */
    public DaoException(String key, Throwable cause, Object[] formatArgs) {
        super(key, cause, formatArgs);
    }

    /**
     * Builder is an implementation of ZekkeExceptionBuilder of DaoException
     * type.
     */
    public static class Builder extends ZekkeExceptionBuilder<DaoException> { }
}